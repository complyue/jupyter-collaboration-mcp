...
class InMemoryEventStore(EventStore):
    ...
    async def get_stream_events(self, stream_id: StreamId, limit: Optional[int] = None) -> List[EventMessage]:
    ...
    async def create_stream(self, stream_id: Optional[StreamId] = None, 
                          metadata: Optional[Dict[str, Any]] = None) -> StreamId:
        """Create a new stream.
    ...
    async def update_stream_metadata(self, stream_id: StreamId, 
    ...
    async def stream_events(self, stream_id: StreamId, 
                          after_event_id: Optional[EventId] = None) -> AsyncIterator[EventMessage]:
