    ...
    def _register_handlers(self):
        ...
        async def list_notebooks(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
            ...
            return [types.TextContent(
                type="text",
                text=json.dumps(notebooks, indent=2)
            )]
        ...
        async def get_notebook(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
            ...
            if not notebook:
                return [types.TextContent(
                    type="text",
                    text=f"Notebook not found: {path}"
                )]
        ...
        @self.server.call_tool()
        async def create_notebook_session(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        @self.server.call_tool()
        async def update_notebook_cell(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
            ...
            result = await self.rtc_adapter.update_notebook_cell(
                path, cell_id, content, cell_type
            )
        ...
        @self.server.call_tool()
        async def insert_notebook_cell(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
            ...
            result = await self.rtc_adapter.insert_notebook_cell(
                path, content, position, cell_type
            )
        ...
        @self.server.call_tool()
        async def delete_notebook_cell(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        @self.server.call_tool()
        async def execute_notebook_cell(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
...
class DocumentHandlers:
    ...
    def _register_handlers(self):
        ...
        @self.server.call_tool()
        async def create_document_session(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        async def update_document(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
            ...
            result = await self.rtc_adapter.update_document(
                path, content, position, length
            )
        ...
        @self.server.call_tool()
        async def get_document_history(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        @self.server.call_tool()
        async def restore_document_version(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        async def fork_document(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
            ...
            result = await self.rtc_adapter.fork_document(
                path, title, description, synchronize
            )
        ...
        @self.server.call_tool()
        async def merge_document_fork(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
...
class AwarenessHandlers:
    ...
    def _register_handlers(self):
        ...
        @self.server.call_tool()
        async def get_online_users(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        @self.server.call_tool()
        async def get_user_presence(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
            ...
            return [types.TextContent(
                type="text",
                text=json.dumps(presence, indent=2)
            )]
        
        @self.server.call_tool()
        async def set_user_presence(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        @self.server.call_tool()
        async def get_user_cursors(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
            ...
            return [types.TextContent(
                type="text",
                text=json.dumps(cursors, indent=2)
            )]
        
        @self.server.call_tool()
        async def update_cursor_position(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        @self.server.call_tool()
        async def get_user_activity(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        @self.server.call_tool()
        async def broadcast_user_activity(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
        ...
        @self.server.call_tool()
        async def get_active_sessions(name: str, arguments: Dict[str, Any]) -> List[types.ContentBlock]:
